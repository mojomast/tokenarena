...
const AUTHOR={
 exchange:{group:'arena',legacy:true,scale:'skirmish',play:['deathmatch','teamdeathmatch','instagib','rockets','arsenal','koth','domination']},
 crosswire:{group:'arena',legacy:true,scale:'skirmish',play:['deathmatch','teamdeathmatch','instagib','rockets','arsenal','koth','domination']},
 foundry:{group:'arena',legacy:true,scale:'skirmish',play:['deathmatch','teamdeathmatch','instagib','rockets','arsenal','koth','domination']},
 launchpad:{group:'arena',legacy:true,scale:'battle',play:['ctf','teamdeathmatch','deathmatch','koth','domination','arsenal','combined-arms']},
 citadel:{group:'arena',legacy:true,scale:'battle',play:['ctf','teamdeathmatch','deathmatch','koth','domination','arsenal']},
 'blood-gulch':{group:'outdoor',legacy:true,scale:'battle',play:['ctf','teamdeathmatch','deathmatch','koth','domination','combined-arms']},
 ...
 'sunscar-canyon':{group:'outdoor',scale:'battle',play:['ctf','teamdeathmatch','deathmatch','koth','domination','combined-arms']},
 ...
 frostline:{group:'outdoor',scale:'warzone',play:['ctf','teamdeathmatch','deathmatch','koth','domination','combined-arms']},
 'derelict-station':{group:'indoor',scale:'warzone',play:['ctf','teamdeathmatch','deathmatch','koth','domination','combined-arms']},
 'ashen-rift':{group:'outdoor',scale:'warzone',play:['ctf','teamdeathmatch','deathmatch','koth','domination','combined-arms']},
