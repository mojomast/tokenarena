...
export const WEAPONS=[
  ...
  {name:'Rocket Launcher',short:'ROCKET',damage:35,splash:60,radius:4,speed:22,interval:.85,range:60,color:'#ffad61',ammo:6,cap:18,recoil:{kick:.05,recover:9,pattern:[[0,0],[.004,.006]]},bloom:{base:.004,perShot:.012,max:.05,recovery:.14,moveFactor:.5},reload:2.6,feel:{kick:[.105,.082,10],shot:[86,.16,'sawtooth',28],launch:[62,.24,'sawtooth',24],impact:[58,.3,'sawtooth',22],tracer:[.16,.08],muzzle:[.2,.1],impactVisual:'burst'}},
  {name:'Rail Lance',short:'RAIL',damage:78,interval:1.25,range:90,color:'#bb9aff',ammo:5,cap:15,recoil:{kick:.06,recover:7,pattern:[[0,0]]},bloom:{base:.001,perShot:.008,max:.02,recovery:.12,moveFactor:.18},reload:2.4,feel:{kick:[.075,.07,13],shot:[1500,.16,'sine',180],launch:[1500,.16,'sine',180],impact:[1900,.1,'sine',2600],tracer:[.25,.12],muzzle:[.16,.09],impactVisual:'ring'}},
  {name:'Scattergun',short:'SCATTER',damage:8,pellets:8,spread:.12,interval:.8,range:24,color:'#ffde87',ammo:10,cap:30,recoil:{kick:.08,recover:10,pattern:[[0,0],[.006,.01]]},bloom:{base:.02,perShot:.02,max:.12,recovery:.16,moveFactor:.6},reload:2.0,feel:{kick:[.12,.085,12],shot:[180,.13,'triangle',35],launch:[180,.13,'triangle',35],impact:[120,.12,'square',55],tracer:[.1,.06],muzzle:[.24,.12],impactVisual:'wide'}},
  {name:'Plasma Driver',short:'PLASMA',damage:25,splash:12,radius:1.6,speed:34,interval:.27,range:65,color:'#72cfff',ammo:24,cap:72,recoil:{kick:.008,recover:16,pattern:[[0,0],[.0018,.002],[0,.0026],[-.0018,.002]]},bloom:{base:.005,perShot:.004,max:.04,recovery:.12,moveFactor:.45},reload:1.8,feel:{kick:[.03,.025,20],shot:[620,.09,'triangle',250],launch:[410,.12,'triangle',140],impact:[260,.16,'sine',80],tracer:[.14,.07],muzzle:[.14,.07],impactVisual:'orb'}},
  {name:'Grenade Launcher',short:'GRENADE',damage:28,splash:42,radius:3.5,speed:18,life:3,gravity:.65,bounce:.45,interval:.95,range:55,color:'#ff806b',ammo:6,cap:18,recoil:{kick:.045,recover:9,pattern:[[0,0],[.003,.005]]},bloom:{base:.004,perShot:.009,max:.05,recovery:.14,moveFactor:.5},reload:2.8,feel:{arc:'high',impact:'heavy',kick:[.095,.075,10],shot:[210,.18,'sawtooth',45],launch:[130,.2,'sawtooth',32],impact:[72,.28,'sawtooth',25],tracer:[.18,.09],muzzle:[.21,.1],impactVisual:'burst'}},
  {name:'Shock Beam',short:'SHOCK',damage:42,interval:.65,range:52,color:'#8ce8ff',ammo:8,cap:24,recoil:{kick:.02,recover:13,pattern:[[0,0],[.002,.003]]},bloom:{base:.003,perShot:.006,max:.04,recovery:.12,moveFactor:.3},reload:2.0,feel:{trace:'instant',impact:'sharp',kick:[.055,.045,16],shot:[480,.1,'square',1100],launch:[480,.1,'square',1100],impact:[900,.08,'square',1500],tracer:[.18,.1],muzzle:[.15,.08],impactVisual:'spark'}},
  {name:'Flak Cannon',short:'FLAK',damage:5,pellets:12,spread:.2,interval:.95,range:22,color:'#ffd166',ammo:10,cap:30,recoil:{kick:.075,recover:10,pattern:[[0,0],[.005,.009]]},bloom:{base:.02,perShot:.018,max:.13,recovery:.15,moveFactor:.6},reload:2.2,feel:{range:'short',impact:'wide',kick:[.115,.09,11],shot:[95,.22,'triangle',30],launch:[95,.22,'triangle',30],impact:[80,.2,'triangle',25],tracer:[.12,.07],muzzle:[.26,.13],impactVisual:'wide'}},
  {name:'Marksman Rifle',short:'MARKSMAN',damage:34,interval:.5,range:80,color:'#ffd27a',ammo:8,cap:24,recoil:{kick:.03,recover:11,pattern:[[0,0],[.002,.004]]},bloom:{base:.002,perShot:.012,max:.03,recovery:.14,moveFactor:.25},reload:2.2,feel:{trace:'instant',impact:'sharp',kick:[.05,.045,14],shot:[700,.09,'square',420],launch:[700,.09,'square',420],impact:[1250,.06,'sine',1850],tracer:[.22,.1],muzzle:[.14,.07],impactVisual:'spark'}},
  {name:'Submachine Gun',short:'SMG',damage:7,interval:.06,range:34,color:'#8affc1',ammo:30,cap:90,recoil:{kick:.008,recover:17,pattern:[[0,0],[.001,.0022],[-.0012,.0026],[.0014,.003],[-.0012,.0032]]},bloom:{base:.008,perShot:.004,max:.06,recovery:.14,moveFactor:.5},reload:1.5,feel:{kick:[.022,.02,22],shot:[540,.06,'square',180],launch:[540,.06,'square',180],impact:[900,.04,'sine',1200],tracer:[.06,.04],muzzle:[.1,.05]}},
];
