...
export const WEAPONS=[
  ...
  {name:'Scattergun',short:'SCATTER',damage:8,pellets:8,spread:.12,interval:.72,range:24,color:'#ffde87',ammo:10,cap:30,recoil:{kick:.08,recover:10,pattern:[[0,0],[.006,.01]]},bloom:{base:.02,perShot:.02,max:.14,recovery:.16,moveFactor:.6},reload:2.0,feel:{kick:[.12,.085,12],shot:[180,.13,'triangle',35],launch:[180,.13,'triangle',35],impact:[120,.12,'square',55],tracer:[.1,.06],muzzle:[.24,.12],impactVisual:'wide'}},
  {name:'Plasma Driver',short:'PLASMA',damage:25,splash:12,radius:1.6,speed:34,interval:.24,range:65,color:'#72cfff',ammo:24,cap:72,recoil:{kick:.008,recover:16,pattern:[[0,0],[.0018,.002],[0,.0026],[-.0018,.002]]},bloom:{base:.005,perShot:.004,max:.04,recovery:.12,moveFactor:.45},reload:1.8,feel:{kick:[.03,.025,20],shot:[620,.09,'triangle',250],launch:[410,.12,'triangle',140],impact:[260,.16,'sine',80],tracer:[.14,.07],muzzle:[.14,.07],impactVisual:'orb'}},
