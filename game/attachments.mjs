...
export const ATTACHMENTS=Object.freeze([
 Object.freeze({id:'extended-mag',slot:'magazine',name:'Extended Magazine',description:'A longer magazine and a slightly slower swap for more rounds.',level:1,weapons:[0,3,4,6,8,9],modifiers:Object.freeze({cap:12,reload:1.1}),behavior:Object.freeze({}),visual:Object.freeze({magazine:'extended'})}),
 Object.freeze({id:'holo-sight',slot:'optic',name:'Holo Sight',description:'A holographic reticle that tightens close-range spread.',level:2,weapons:[0,3,4,6,7,9],modifiers:Object.freeze({spread:.9}),behavior:Object.freeze({}),visual:Object.freeze({optic:'holo'})}),
 Object.freeze({id:'long-barrel',slot:'barrel',name:'Long Barrel',description:'A longer barrel for reach and striking power.',level:3,weapons:[0,2,4,6,8,9],modifiers:Object.freeze({range:1.25,spread:.92,damage:1.06}),behavior:Object.freeze({}),visual:Object.freeze({barrel:'long'})}),
 Object.freeze({id:'quickdraw-grip',slot:'underbarrel',name:'Quickdraw Grip',description:'A forward grip that speeds handling and steadiness.',level:4,weapons:[],modifiers:Object.freeze({reload:.82,spread:.94,interval:.96}),behavior:Object.freeze({}),visual:Object.freeze({color:'#4a5a62'})}),
 Object.freeze({id:'scope',slot:'optic',name:'Precision Scope',description:'Magnified optics trade field of view for accuracy at range.',level:5,weapons:[0,2,4,8],modifiers:Object.freeze({spread:.8,range:1.2}),behavior:Object.freeze({}),visual:Object.freeze({optic:'scope'})}),
 Object.freeze({id:'suppressor',slot:'barrel',name:'Suppressor',description:'A quiet barrel that tames kick but softens damage and reach.',level:6,weapons:[0,4,6,8,9],modifiers:Object.freeze({damage:.92,spread:.9,recoilKick:.82,range:.95}),behavior:Object.freeze({}),visual:Object.freeze({barrel:'long',color:'#2f3a3f'})}),
 Object.freeze({id:'burst-module',slot:'underbarrel',name:'Burst Module',description:'A fire-control module that groups each trigger pull into a burst.',level:8,weapons:[0,4,9],modifiers:Object.freeze({burst:3,interval:1.05}),behavior:Object.freeze({mode:'burst',burst:3,burstDelay:.16}),visual:Object.freeze({color:'#8affc1'})}),
 Object.freeze({id:'charge-coil',slot:'barrel',name:'Charge Coil',description:'Stores energy for a charged shot with doubled impact.',level:10,weapons:[4,6],modifiers:Object.freeze({damage:1.15,interval:1.25}),behavior:Object.freeze({mode:'charge',chargeTime:.5,chargeDamage:2.2}),visual:Object.freeze({barrel:'heavy',color:'#72cfff'})}),
 Object.freeze({id:'drum-mag',slot:'magazine',name:'Drum Magazine',description:'A high-capacity drum for sustained automatic fire.',level:12,weapons:[0,4,9],modifiers:Object.freeze({cap:45,reload:1.35,spread:1.05}),behavior:Object.freeze({}),visual:Object.freeze({magazine:'drum',color:'#3b4a52'})}),
 Object.freeze({id:'piercing-rounds',slot:'magazine',name:'Piercing Rounds',description:'Hardened rounds that punch through a line of targets.',level:14,weapons:[2,8],modifiers:Object.freeze({damage:.92,range:1.1}),behavior:Object.freeze({mode:'pierce',pierce:2}),visual:Object.freeze({magazine:'stock',color:'#bb9aff'})}),
 Object.freeze({id:'grenade-launcher',slot:'underbarrel',name:'Grenade Launcher',description:'An underbarrel tube that lobs a small explosive on each shot.',level:15,weapons:[0,9],modifiers:Object.freeze({damage:.96,spread:1.06}),behavior:Object.freeze({mode:'explosive',explosiveRadius:3.2,explosiveDamage:.5}),visual:Object.freeze({color:'#ff806b'})}),
 Object.freeze({id:'explosive-tips',slot:'magazine',name:'Explosive Tips',description:'Impact-fused rounds that detonate for area damage.',level:16,weapons:[1,4,5],modifiers:Object.freeze({damage:1.05,spread:1.08}),behavior:Object.freeze({mode:'explosive',explosiveRadius:2.6,explosiveDamage:.45}),visual:Object.freeze({magazine:'stock',color:'#ffad61'})}),
 Object.freeze({id:'homing-beacon',slot:'underbarrel',name:'Homing Beacon',description:'A targeting beacon that steers projectiles toward the target.',level:18,weapons:[1,4],modifiers:Object.freeze({spread:.95}),behavior:Object.freeze({mode:'homing',homing:.6,turnRate:3}),visual:Object.freeze({color:'#ffd166'})}),
 Object.freeze({id:'chain-capacitor',slot:'underbarrel',name:'Chain Capacitor',description:'Arcs residual energy from a hit into a nearby second target.',level:20,weapons:[4,6],modifiers:Object.freeze({damage:.95,spread:.95}),behavior:Object.freeze({mode:'chain',chain:2,chainRange:6}),visual:Object.freeze({color:'#8ce8ff'})}),
]);
